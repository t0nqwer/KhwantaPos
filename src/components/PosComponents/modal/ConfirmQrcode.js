...
const ConfirmQrcode = ({ subtotal, func, back }) => {
  return (
    <div className="fixed bg-secondary w-full h-full top-0 left-0 bg-opacity-75 backdrop-blur-md flex justify-center items-center z-[1000]">
      ...
      >
        <div className="w-full text-2xl text-center text-white mt-9 tracking-widestt "> ยอดScan / โอน </div>
        ...
        <div className="w-full text-xl tracking-wider text-center text-red-500">**กรุณาทำรายการโอนให้สำเร็จแล้วกดยืนยัน**</div>
